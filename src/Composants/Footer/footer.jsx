...
let Footer = ()=>{
    ...
    return <div className='bg-black  h-[100px] flex flex-col  justify-center items-center '>
                <div className='flex  w-[100%] justify-center items-center text-white'>
                    <div className='flex pl-[20px] sm:pl-[100px]  h-[50px] w-[95%] justify-center items-center text-white gap-5 '>
