    ...
    return <>
            <div id="propos" className="h-min w-full flex flex-col  sm:flex sm:flex-row sm:mt-[100px]" >
                <div className="w-[100%]  h-[80vh] flex justify-center items-center flex-col sm:w-1/2 ">
                    <p className="text-orange-500 mt-[30px] mb-[-40px]  text-center font-bold text-[35px]  h-[100px] w-[400px] sm:mt-[40px]  "> À Propos <span className="text-black"> de Nous </span> </p>
                    <p className=" flex text-center items-center w-[80%]  h-[400px]   font-thin sm:h-[500px] sm:w-[80%] sm:text-[20px] sm:hover:scale-110 duration-300 ease-in">
