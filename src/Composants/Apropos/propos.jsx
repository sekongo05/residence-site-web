let Propos = ()=>{
    ...
    return <>
            <div id="propos" className="h-min w-full flex flex-col  overflow-hidden sm:flex sm:flex-row sm:mt-[100px]" >
                <div   className="w-[100%]  h-[80vh] flex justify-center items-center flex-col sm:w-1/2 ">
                    ...
                    <p data-aos="fade-up"  data-aos-duration="1000"className=" flex text-center items-center w-[90%]  h-[400px]  sm:h-[500px] sm:w-[80%] sm:text-[20px] sm:hover:scale-110 duration-300 ease-in">
                ...
                <div   className="w-[100%] h-[50vh] flex  justify-center items-center  sm:h-[80vh] sm:w-1/2">
                    <div data-aos="flip-left" className=" h-[350px] w-[90%]  rounded-br-[180px] rounded-tl-[180px]  overflow-hidden   sm:h-[500px] sm:w-[70%] sm:hover:scale-110 duration-300 ease-in" > 
