    ...
    return <>
            <div id="propos" className="h-min w-full flex flex-col  overflow-hidden sm:flex sm:flex-row sm:mt-[100px]" >
                <div   className="w-[100%]  h-[80vh] flex justify-center items-center flex-col sm:w-1/2 ">
                    ...
                    <p  data-aos="fade-right" className=" flex text-center items-center w-[90%]  h-[400px]  sm:h-[500px] sm:w-[80%] sm:text-[20px] sm:hover:scale-110 duration-300 ease-in">
                ...
                <div  data-aos="fade-left" className="w-[100%] h-[50vh] flex  justify-center items-center  sm:h-[80vh] sm:w-1/2">
